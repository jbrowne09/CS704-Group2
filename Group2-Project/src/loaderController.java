...
public class loaderController extends ClockDomain{
  ...
  public void thread6033(int [] tdone, int [] ends){
        switch(S6019){
      case 0 : 
        active[5]=0;
        ends[5]=0;
  ...
  public void thread6031(int [] tdone, int [] ends){
        switch(S5792){
      case 0 : 
        active[4]=0;
        ends[4]=0;
  ...
  public void thread6030(int [] tdone, int [] ends){
        switch(S5787){
      case 0 : 
        active[3]=0;
        ends[3]=0;
        ...
        switch(S5770){
          ...
          case 4 : 
            if(!tick.getprestatus()){//sysj\loaderController.sysj line: 19, column: 10
              ...
              int biggest6029 = 0;
              if(ends[3]>=biggest6029){
                biggest6029=ends[3];
              }
              if(ends[4]>=biggest6029){
                biggest6029=ends[4];
              }
              if(biggest6029 == 1){
                active[2]=1;
          ...
          case 5 : 
            if(tick.getprestatus()){//sysj\loaderController.sysj line: 20, column: 10
              ...
              thread6030(tdone,ends);
              thread6031(tdone,ends);
              int biggest6032 = 0;
              if(ends[3]>=biggest6032){
                biggest6032=ends[3];
              }
              if(ends[4]>=biggest6032){
                biggest6032=ends[4];
              }
              if(biggest6032 == 1){
                active[2]=1;
    ...
    RUN: while(true){
      switch(S6021){
        ...
        case 1 : 
          ...
          int biggest6025 = 0;
          if(ends[2]>=biggest6025){
            biggest6025=ends[2];
          }
          if(ends[5]>=biggest6025){
            biggest6025=ends[5];
          }
          if(biggest6025 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          thread6033(tdone,ends);
          int biggest6034 = 0;
          if(ends[2]>=biggest6034){
            biggest6034=ends[2];
          }
          if(ends[5]>=biggest6034){
            biggest6034=ends[5];
          }
          if(biggest6034 == 1){
            active[1]=1;
