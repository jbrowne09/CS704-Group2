...
public class loaderController extends ClockDomain{
  ...
  public void thread3418(int [] tdone, int [] ends){
        switch(S3175){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread3416(int [] tdone, int [] ends){
        S3180=1;
    getBottle.setPresent();//sysj\loaderController.sysj line: 23, column: 6
    currsigs.addElement(getBottle);
    active[4]=1;
  ...
  public void thread3415(int [] tdone, int [] ends){
        S3175=1;
    CMD.setPresent();//sysj\loaderController.sysj line: 21, column: 6
    currsigs.addElement(CMD);
    CMD.setValue("G");//sysj\loaderController.sysj line: 21, column: 6
  ...
  public void thread3414(int [] tdone, int [] ends){
        switch(S3399){
      case 0 : 
        active[2]=0;
        ends[2]=0;
        ...
        switch(S3158){
          ...
          case 4 : 
            if(!tick.getprestatus()){//sysj\loaderController.sysj line: 19, column: 10
              S3158=5;
              thread3415(tdone,ends);
              thread3416(tdone,ends);
              int biggest3417 = 0;
              if(ends[3]>=biggest3417){
                biggest3417=ends[3];
              }
              if(ends[4]>=biggest3417){
                biggest3417=ends[4];
              }
              if(biggest3417 == 1){
                active[2]=1;
          ...
          case 5 : 
            if(tick.getprestatus()){//sysj\loaderController.sysj line: 20, column: 10
              ...
              thread3418(tdone,ends);
              thread3419(tdone,ends);
              int biggest3420 = 0;
              if(ends[3]>=biggest3420){
                biggest3420=ends[3];
              }
              if(ends[4]>=biggest3420){
                biggest3420=ends[4];
              }
              if(biggest3420 == 1){
                active[2]=1;
  ...
  public void thread3412(int [] tdone, int [] ends){
        S3407=1;
    if(loaderDone.getprestatus()){//sysj\loaderController.sysj line: 52, column: 24
      NloaderDone.setPresent();//sysj\loaderController.sysj line: 52, column: 37
      currsigs.addElement(NloaderDone);
  ...
  public void thread3411(int [] tdone, int [] ends){
        S3399=1;
    S3158=0;
    active[2]=1;
    ends[2]=1;
    ...
    RUN: while(true){
      switch(S3409){
        ...
        case 1 : 
          S3409=2;
          S3409=2;
          thread3411(tdone,ends);
          thread3412(tdone,ends);
          int biggest3413 = 0;
          if(ends[2]>=biggest3413){
            biggest3413=ends[2];
          }
          if(ends[5]>=biggest3413){
            biggest3413=ends[5];
          }
          if(biggest3413 == 1){
            active[1]=1;
        ...
        case 2 : 
          thread3414(tdone,ends);
          thread3421(tdone,ends);
          int biggest3422 = 0;
          if(ends[2]>=biggest3422){
            biggest3422=ends[2];
          }
          if(ends[5]>=biggest3422){
            biggest3422=ends[5];
          }
          if(biggest3422 == 1){
            active[1]=1;
