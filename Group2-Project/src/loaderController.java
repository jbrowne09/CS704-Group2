        ...
        switch(S1885){
          ...
          case 6 : 
            if(!tick.getprestatus()){//sysj\loaderController.sysj line: 24, column: 10
              ...
              int biggest2144 = 0;
              if(ends[3]>=biggest2144){
                biggest2144=ends[3];
              }
              if(ends[4]>=biggest2144){
                biggest2144=ends[4];
              }
              if(biggest2144 == 1){
                active[2]=1;
          ...
          case 7 : 
            if(tick.getprestatus()){//sysj\loaderController.sysj line: 25, column: 10
              ...
              int biggest2147 = 0;
              if(ends[3]>=biggest2147){
                biggest2147=ends[3];
              }
              if(ends[4]>=biggest2147){
                biggest2147=ends[4];
              }
              if(biggest2147 == 1){
                active[2]=1;
    ...
    RUN: while(true){
      switch(S2136){
        ...
        case 1 : 
          ...
          int biggest2140 = 0;
          if(ends[2]>=biggest2140){
            biggest2140=ends[2];
          }
          if(ends[5]>=biggest2140){
            biggest2140=ends[5];
          }
          if(biggest2140 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest2149 = 0;
          if(ends[2]>=biggest2149){
            biggest2149=ends[2];
          }
          if(ends[5]>=biggest2149){
            biggest2149=ends[5];
          }
          if(biggest2149 == 1){
            active[1]=1;
