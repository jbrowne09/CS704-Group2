    ...
    RUN: while(true){
      switch(S476){
        ...
        case 2 : 
          switch(S414){
            case 0 : 
              if(enableRotary.getprestatus()){//sysj\rotaryController.sysj line: 9, column: 9
                S414=1;
                System.out.println("cap on bottle in Pos1 or Pos5, please remove it");//sysj\rotaryController.sysj line: 11, column: 4
                active[1]=1;
                ends[1]=1;
                break RUN;
              }
            ...
            case 1 : 
              if(!capPos1.getprestatus() && !bottlePos5.getprestatus()){//sysj\rotaryController.sysj line: 10, column: 9
                S414=2;
                System.out.println("rotating");//sysj\rotaryController.sysj line: 15, column: 4
            ...
            case 2 : 
              if(aligned.getprestatus()){//sysj\rotaryController.sysj line: 14, column: 9
                S414=0;
                active[1]=1;
                ends[1]=1;
                break RUN;
