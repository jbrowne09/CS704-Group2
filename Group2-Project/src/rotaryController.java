...
public class rotaryController extends ClockDomain{
  ...
  public void thread3327(int [] tdone, int [] ends){
        switch(S3304){
      case 0 : 
        active[6]=0;
        ends[6]=0;
    ...
    RUN: while(true){
      switch(S3314){
        ...
        case 1 : 
          ...
          if(ends[4]>=biggest3322){
            biggest3322=ends[4];
          }
          if(ends[5]>=biggest3322){
            biggest3322=ends[5];
          }
          if(ends[6]>=biggest3322){
            biggest3322=ends[6];
          }
          if(ends[7]>=biggest3322){
            biggest3322=ends[7];
          }
          if(biggest3322 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          thread3327(tdone,ends);
          thread3328(tdone,ends);
          int biggest3329 = 0;
          if(ends[2]>=biggest3329){
            biggest3329=ends[2];
          }
          if(ends[3]>=biggest3329){
            biggest3329=ends[3];
          }
          if(ends[4]>=biggest3329){
            biggest3329=ends[4];
          }
          if(ends[5]>=biggest3329){
            biggest3329=ends[5];
          }
          if(ends[6]>=biggest3329){
            biggest3329=ends[6];
          }
          if(ends[7]>=biggest3329){
            biggest3329=ends[7];
          }
          if(biggest3329 == 1){
            active[1]=1;
