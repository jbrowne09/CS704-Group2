...
public class rotaryController extends ClockDomain{
  ...
  public void thread4819(int [] tdone, int [] ends){
        switch(S4796){
      case 0 : 
        active[6]=0;
        ends[6]=0;
  ...
  public void thread4816(int [] tdone, int [] ends){
        switch(S4772){
      case 0 : 
        active[3]=0;
        ends[3]=0;
    ...
    RUN: while(true){
      switch(S4806){
        ...
        case 1 : 
          ...
          int biggest4814 = 0;
          if(ends[2]>=biggest4814){
            biggest4814=ends[2];
          }
          if(ends[3]>=biggest4814){
            biggest4814=ends[3];
          }
          if(ends[4]>=biggest4814){
            biggest4814=ends[4];
          }
          if(ends[5]>=biggest4814){
            biggest4814=ends[5];
          }
          if(ends[6]>=biggest4814){
            biggest4814=ends[6];
          }
          if(ends[7]>=biggest4814){
            biggest4814=ends[7];
          }
          if(biggest4814 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          thread4816(tdone,ends);
          thread4817(tdone,ends);
          thread4818(tdone,ends);
          thread4819(tdone,ends);
          thread4820(tdone,ends);
          int biggest4821 = 0;
          if(ends[2]>=biggest4821){
            biggest4821=ends[2];
          }
          if(ends[3]>=biggest4821){
            biggest4821=ends[3];
          }
          if(ends[4]>=biggest4821){
            biggest4821=ends[4];
          }
          if(ends[5]>=biggest4821){
            biggest4821=ends[5];
          }
          if(ends[6]>=biggest4821){
            biggest4821=ends[6];
          }
          if(ends[7]>=biggest4821){
            biggest4821=ends[7];
          }
          if(biggest4821 == 1){
            active[1]=1;
