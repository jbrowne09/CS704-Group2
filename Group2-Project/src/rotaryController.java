    ...
    RUN: while(true){
      switch(S3302){
        ...
        case 1 : 
          ...
          int biggest3310 = 0;
          if(ends[2]>=biggest3310){
            biggest3310=ends[2];
          }
          if(ends[3]>=biggest3310){
            biggest3310=ends[3];
          }
          if(ends[4]>=biggest3310){
            biggest3310=ends[4];
          }
          if(ends[5]>=biggest3310){
            biggest3310=ends[5];
          }
          if(ends[6]>=biggest3310){
            biggest3310=ends[6];
          }
          if(ends[7]>=biggest3310){
            biggest3310=ends[7];
          }
          if(biggest3310 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3317 = 0;
          if(ends[2]>=biggest3317){
            biggest3317=ends[2];
          }
          if(ends[3]>=biggest3317){
            biggest3317=ends[3];
          }
          if(ends[4]>=biggest3317){
            biggest3317=ends[4];
          }
          if(ends[5]>=biggest3317){
            biggest3317=ends[5];
          }
          if(ends[6]>=biggest3317){
            biggest3317=ends[6];
          }
          if(ends[7]>=biggest3317){
            biggest3317=ends[7];
          }
          if(biggest3317 == 1){
            active[1]=1;
