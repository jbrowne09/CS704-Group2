          ...
          switch(S1096){
            case 0 : 
              if(tick.getprestatus()){//sysj\fillerController.sysj line: 9, column: 9
                ...
                int biggest1294 = 0;
                if(ends[2]>=biggest1294){
                  biggest1294=ends[2];
                }
                if(ends[3]>=biggest1294){
                  biggest1294=ends[3];
                }
                if(biggest1294 == 1){
                  active[1]=1;
            ...
            case 1 : 
              if(canTop.getprestatus()){//sysj\fillerController.sysj line: 10, column: 9
                ...
                int biggest1297 = 0;
                if(ends[4]>=biggest1297){
                  biggest1297=ends[4];
                }
                if(ends[5]>=biggest1297){
                  biggest1297=ends[5];
                }
                if(biggest1297 == 1){
                  active[1]=1;
                ...
                if(biggest1300 == 0){
                  ...
                  int biggest1303 = 0;
                  if(ends[4]>=biggest1303){
                    biggest1303=ends[4];
                  }
                  if(ends[5]>=biggest1303){
                    biggest1303=ends[5];
                  }
                  if(biggest1303 == 1){
                    active[1]=1;
            ...
            case 2 : 
              if(canBottom.getprestatus()){//sysj\fillerController.sysj line: 18, column: 9
                ...
                int biggest1306 = 0;
                if(ends[4]>=biggest1306){
                  biggest1306=ends[4];
                }
                if(ends[5]>=biggest1306){
                  biggest1306=ends[5];
                }
                if(biggest1306 == 1){
                  active[1]=1;
