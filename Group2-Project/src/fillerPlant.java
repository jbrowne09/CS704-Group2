...
public class fillerPlant extends ClockDomain{
  ...
  public void thread1276(int [] tdone, int [] ends){
    ...
    if(ends[7]>=biggest1286){
      biggest1286=ends[7];
    }
    if(ends[8]>=biggest1286){
      biggest1286=ends[8];
    }
    if(ends[9]>=biggest1286){
      biggest1286=ends[9];
    }
    if(ends[10]>=biggest1286){
      biggest1286=ends[10];
    }
    if(ends[11]>=biggest1286){
      biggest1286=ends[11];
    }
    if(ends[12]>=biggest1286){
      biggest1286=ends[12];
    }
    if(ends[13]>=biggest1286){
      biggest1286=ends[13];
    }
    if(ends[14]>=biggest1286){
      biggest1286=ends[14];
    }
    if(biggest1286 == 1){
      active[5]=1;
  ...
  public void thread1261(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1271 = 0;
        if(ends[6]>=biggest1271){
          biggest1271=ends[6];
        }
        if(ends[7]>=biggest1271){
          biggest1271=ends[7];
        }
        if(ends[8]>=biggest1271){
          biggest1271=ends[8];
        }
        if(ends[9]>=biggest1271){
          biggest1271=ends[9];
        }
        if(ends[10]>=biggest1271){
          biggest1271=ends[10];
        }
        if(ends[11]>=biggest1271){
          biggest1271=ends[11];
        }
        if(ends[12]>=biggest1271){
          biggest1271=ends[12];
        }
        if(ends[13]>=biggest1271){
          biggest1271=ends[13];
        }
        if(ends[14]>=biggest1271){
          biggest1271=ends[14];
        }
        if(biggest1271 == 1){
          active[5]=1;
  ...
  public void thread1246(int [] tdone, int [] ends){
    ...
    if(ends[9]>=biggest1256){
      biggest1256=ends[9];
    }
    if(ends[10]>=biggest1256){
      biggest1256=ends[10];
    }
    if(ends[11]>=biggest1256){
      biggest1256=ends[11];
    }
    if(ends[12]>=biggest1256){
      biggest1256=ends[12];
    }
    if(ends[13]>=biggest1256){
      biggest1256=ends[13];
    }
    if(ends[14]>=biggest1256){
      biggest1256=ends[14];
    }
    if(biggest1256 == 1){
      active[5]=1;
    ...
    RUN: while(true){
      switch(S1241){
        ...
        case 1 : 
          ...
          int biggest1257 = 0;
          if(ends[2]>=biggest1257){
            biggest1257=ends[2];
          }
          if(ends[3]>=biggest1257){
            biggest1257=ends[3];
          }
          if(ends[4]>=biggest1257){
            biggest1257=ends[4];
          }
          if(ends[5]>=biggest1257){
            biggest1257=ends[5];
          }
          if(biggest1257 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          if(biggest1272 == 0){
            ...
            int biggest1287 = 0;
            if(ends[2]>=biggest1287){
              biggest1287=ends[2];
            }
            if(ends[3]>=biggest1287){
              biggest1287=ends[3];
            }
