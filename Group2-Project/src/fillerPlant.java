...
public class fillerPlant extends ClockDomain{
  ...
  public void thread1688(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1695 = 0;
        if(ends[6]>=biggest1695){
          biggest1695=ends[6];
        }
        if(ends[7]>=biggest1695){
          biggest1695=ends[7];
        }
        if(ends[8]>=biggest1695){
          biggest1695=ends[8];
        }
        if(ends[9]>=biggest1695){
          biggest1695=ends[9];
        }
        if(ends[10]>=biggest1695){
          biggest1695=ends[10];
        }
        if(ends[11]>=biggest1695){
          biggest1695=ends[11];
        }
        if(biggest1695 == 1){
          active[5]=1;
    ...
    RUN: while(true){
      switch(S1671){
        ...
        case 1 : 
          ...
          int biggest1684 = 0;
          if(ends[2]>=biggest1684){
            biggest1684=ends[2];
          }
          if(ends[3]>=biggest1684){
            biggest1684=ends[3];
          }
          if(ends[4]>=biggest1684){
            biggest1684=ends[4];
          }
          if(ends[5]>=biggest1684){
            biggest1684=ends[5];
          }
          if(biggest1684 == 1){
            active[1]=1;
