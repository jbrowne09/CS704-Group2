...
public class fillerPlant extends ClockDomain{
  ...
  public void thread3144(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest3153 = 0;
        if(ends[4]>=biggest3153){
          biggest3153=ends[4];
        }
        if(ends[5]>=biggest3153){
          biggest3153=ends[5];
        }
        if(ends[6]>=biggest3153){
          biggest3153=ends[6];
        }
        if(ends[7]>=biggest3153){
          biggest3153=ends[7];
        }
        if(ends[8]>=biggest3153){
          biggest3153=ends[8];
        }
        if(ends[9]>=biggest3153){
          biggest3153=ends[9];
        }
        if(ends[10]>=biggest3153){
          biggest3153=ends[10];
        }
        if(ends[11]>=biggest3153){
          biggest3153=ends[11];
        }
        if(biggest3153 == 1){
          active[3]=1;
  ...
  public void thread3132(int [] tdone, int [] ends){
    ...
    int biggest3141 = 0;
    if(ends[4]>=biggest3141){
      biggest3141=ends[4];
    }
    if(ends[5]>=biggest3141){
      biggest3141=ends[5];
    }
    if(ends[6]>=biggest3141){
      biggest3141=ends[6];
    }
    if(ends[7]>=biggest3141){
      biggest3141=ends[7];
    }
    if(ends[8]>=biggest3141){
      biggest3141=ends[8];
    }
    if(ends[9]>=biggest3141){
      biggest3141=ends[9];
    }
    if(ends[10]>=biggest3141){
      biggest3141=ends[10];
    }
    if(ends[11]>=biggest3141){
      biggest3141=ends[11];
    }
    if(biggest3141 == 1){
      active[3]=1;
    ...
    RUN: while(true){
      switch(S3129){
        ...
        case 1 : 
          ...
          int biggest3142 = 0;
          if(ends[2]>=biggest3142){
            biggest3142=ends[2];
          }
          if(ends[3]>=biggest3142){
            biggest3142=ends[3];
          }
          if(biggest3142 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3154 = 0;
          if(ends[2]>=biggest3154){
            biggest3154=ends[2];
          }
          if(ends[3]>=biggest3154){
            biggest3154=ends[3];
          }
          if(biggest3154 == 1){
            active[1]=1;
