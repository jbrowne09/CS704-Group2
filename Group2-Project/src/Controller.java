...
public class Controller extends ClockDomain{
  ...
  public void thread6327(int [] tdone, int [] ends){
        switch(S5931){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread6324(int [] tdone, int [] ends){
        S5931=1;
    S5930=0;
    active[3]=1;
    ends[3]=1;
              ...
              switch(S5902){
                ...
                case 4 : 
                  if(armAtSource.getprestatus()){//sysj\wLoaderController.sysj line: 24, column: 12
                    ...
                    thread6324(tdone,ends);
                    int biggest6325 = 0;
                    if(ends[2]>=biggest6325){
                      biggest6325=ends[2];
                    }
                    if(ends[3]>=biggest6325){
                      biggest6325=ends[3];
                    }
                    if(biggest6325 == 1){
                      active[1]=1;
                ...
                case 5 : 
                  if(armAtDest.getprestatus()){//sysj\wLoaderController.sysj line: 27, column: 12
                    ...
                    thread6327(tdone,ends);
                    int biggest6328 = 0;
                    if(ends[2]>=biggest6328){
                      biggest6328=ends[2];
                    }
                    if(ends[3]>=biggest6328){
                      biggest6328=ends[3];
                    }
                    if(biggest6328 == 1){
                      active[1]=1;
