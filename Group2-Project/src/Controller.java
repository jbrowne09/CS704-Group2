...
public class Controller extends ClockDomain{
  ...
  public void thread3202(int [] tdone, int [] ends){
        switch(S2806){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread3201(int [] tdone, int [] ends){
        active[2]=0;
    ends[2]=0;
    tdone[2]=1;
  }
              ...
              switch(S2777){
                ...
                case 4 : 
                  if(armAtSource.getprestatus()){//sysj\wLoaderController.sysj line: 24, column: 12
                    ...
                    int biggest3200 = 0;
                    if(ends[2]>=biggest3200){
                      biggest3200=ends[2];
                    }
                    if(ends[3]>=biggest3200){
                      biggest3200=ends[3];
                    }
                    if(biggest3200 == 1){
                      active[1]=1;
                ...
                case 5 : 
                  if(armAtDest.getprestatus()){//sysj\wLoaderController.sysj line: 27, column: 12
                    ...
                    thread3201(tdone,ends);
                    thread3202(tdone,ends);
                    int biggest3203 = 0;
                    if(ends[2]>=biggest3203){
                      biggest3203=ends[2];
                    }
                    if(ends[3]>=biggest3203){
                      biggest3203=ends[3];
                    }
                    if(biggest3203 == 1){
                      active[1]=1;
