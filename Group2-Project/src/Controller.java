...
public class Controller extends ClockDomain{
  ...
  public void thread6317(int [] tdone, int [] ends){
        switch(S5921){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread6316(int [] tdone, int [] ends){
        active[2]=0;
    ends[2]=0;
    tdone[2]=1;
  }

  public void thread6314(int [] tdone, int [] ends){
        S5921=1;
    S5920=0;
    active[3]=1;
    ends[3]=1;
  ...
  public void thread6313(int [] tdone, int [] ends){
              ...
              switch(S5892){
                ...
                case 4 : 
                  if(armAtSource.getprestatus()){//sysj\wLoaderController.sysj line: 24, column: 12
                    S5892=5;
                    thread6313(tdone,ends);
                    thread6314(tdone,ends);
                    int biggest6315 = 0;
                    if(ends[2]>=biggest6315){
                      biggest6315=ends[2];
                    }
                    if(ends[3]>=biggest6315){
                      biggest6315=ends[3];
                    }
                    if(biggest6315 == 1){
                      active[1]=1;
                ...
                case 5 : 
                  if(armAtDest.getprestatus()){//sysj\wLoaderController.sysj line: 27, column: 12
                    ...
                    thread6316(tdone,ends);
                    thread6317(tdone,ends);
                    int biggest6318 = 0;
                    if(ends[2]>=biggest6318){
                      biggest6318=ends[2];
                    }
                    if(ends[3]>=biggest6318){
                      biggest6318=ends[3];
                    }
                    if(biggest6318 == 1){
                      active[1]=1;
