...
public class mainController extends ClockDomain{
  ...
  public void thread2829(int [] tdone, int [] ends){
        S2787=1;
    S2765=0;
    active[8]=1;
    ends[8]=1;
    ...
    RUN: while(true){
      switch(S2821){
        ...
        case 1 : 
          ...
          thread2829(tdone,ends);
          thread2830(tdone,ends);
          int biggest2831 = 0;
          if(ends[2]>=biggest2831){
            biggest2831=ends[2];
          }
          if(ends[3]>=biggest2831){
            biggest2831=ends[3];
          }
          if(ends[4]>=biggest2831){
            biggest2831=ends[4];
          }
          if(ends[5]>=biggest2831){
            biggest2831=ends[5];
          }
          if(ends[6]>=biggest2831){
            biggest2831=ends[6];
          }
          if(ends[7]>=biggest2831){
            biggest2831=ends[7];
          }
          if(ends[8]>=biggest2831){
            biggest2831=ends[8];
          }
          if(ends[9]>=biggest2831){
            biggest2831=ends[9];
          }
          if(biggest2831 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest2840 = 0;
          if(ends[2]>=biggest2840){
            biggest2840=ends[2];
          }
          if(ends[3]>=biggest2840){
            biggest2840=ends[3];
          }
          if(ends[4]>=biggest2840){
            biggest2840=ends[4];
          }
          if(ends[5]>=biggest2840){
            biggest2840=ends[5];
          }
          if(ends[6]>=biggest2840){
            biggest2840=ends[6];
          }
          if(ends[7]>=biggest2840){
            biggest2840=ends[7];
          }
          if(ends[8]>=biggest2840){
            biggest2840=ends[8];
          }
          if(ends[9]>=biggest2840){
            biggest2840=ends[9];
          }
          if(biggest2840 == 1){
            active[1]=1;
