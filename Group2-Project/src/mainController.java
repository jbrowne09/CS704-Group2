    ...
    RUN: while(true){
      switch(S2423){
        ...
        case 1 : 
          ...
          int biggest2430 = 0;
          if(ends[2]>=biggest2430){
            biggest2430=ends[2];
          }
          if(ends[3]>=biggest2430){
            biggest2430=ends[3];
          }
          if(ends[4]>=biggest2430){
            biggest2430=ends[4];
          }
          if(ends[5]>=biggest2430){
            biggest2430=ends[5];
          }
          if(ends[6]>=biggest2430){
            biggest2430=ends[6];
          }
          if(biggest2430 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          if(ends[4]>=biggest2436){
            biggest2436=ends[4];
          }
          if(ends[5]>=biggest2436){
            biggest2436=ends[5];
          }
          if(ends[6]>=biggest2436){
            biggest2436=ends[6];
          }
          if(biggest2436 == 1){
            active[1]=1;
