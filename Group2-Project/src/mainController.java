...
public class mainController extends ClockDomain{
  ...
  public void thread2654(int [] tdone, int [] ends){
      ...
      case 1 : 
        switch(S2618){
          case 0 : 
            if(bottleAtLoad.getprestatus()){//sysj\mainController.sysj line: 67, column: 10
              S2618=1;
              bottleAtLoadS.setPresent();//sysj\mainController.sysj line: 69, column: 5
          ...
          case 1 : 
            if(getBottle.getprestatus()){//sysj\mainController.sysj line: 68, column: 10
              S2618=0;
              active[6]=1;
              ends[6]=1;
              tdone[6]=1;
    ...
    RUN: while(true){
      switch(S2642){
        ...
        case 1 : 
          ...
          int biggest2649 = 0;
          if(ends[2]>=biggest2649){
            biggest2649=ends[2];
          }
          if(ends[3]>=biggest2649){
            biggest2649=ends[3];
          }
          if(ends[4]>=biggest2649){
            biggest2649=ends[4];
          }
          if(ends[5]>=biggest2649){
            biggest2649=ends[5];
          }
          if(ends[6]>=biggest2649){
            biggest2649=ends[6];
          }
          if(biggest2649 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest2655 = 0;
          if(ends[2]>=biggest2655){
            biggest2655=ends[2];
          }
          if(ends[3]>=biggest2655){
            biggest2655=ends[3];
          }
