...
public class mainController extends ClockDomain{
  ...
  public void thread2635(int [] tdone, int [] ends){
        switch(S2516){
      case 0 : 
        active[6]=0;
        ends[6]=0;
    ...
    RUN: while(true){
      switch(S2620){
        ...
        case 1 : 
          ...
          int biggest2630 = 0;
          if(ends[2]>=biggest2630){
            biggest2630=ends[2];
          }
          if(ends[3]>=biggest2630){
            biggest2630=ends[3];
          }
          if(ends[4]>=biggest2630){
            biggest2630=ends[4];
          }
          if(ends[5]>=biggest2630){
            biggest2630=ends[5];
          }
          if(ends[6]>=biggest2630){
            biggest2630=ends[6];
          }
          if(ends[7]>=biggest2630){
            biggest2630=ends[7];
          }
          if(ends[8]>=biggest2630){
            biggest2630=ends[8];
          }
          if(ends[9]>=biggest2630){
            biggest2630=ends[9];
          }
          if(biggest2630 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          thread2635(tdone,ends);
          thread2636(tdone,ends);
          thread2637(tdone,ends);
          thread2638(tdone,ends);
          int biggest2639 = 0;
          if(ends[2]>=biggest2639){
            biggest2639=ends[2];
          }
          if(ends[3]>=biggest2639){
            biggest2639=ends[3];
          }
          if(ends[4]>=biggest2639){
            biggest2639=ends[4];
          }
          if(ends[5]>=biggest2639){
            biggest2639=ends[5];
          }
          if(ends[6]>=biggest2639){
            biggest2639=ends[6];
          }
          if(ends[7]>=biggest2639){
            biggest2639=ends[7];
          }
          if(ends[8]>=biggest2639){
            biggest2639=ends[8];
          }
          if(ends[9]>=biggest2639){
            biggest2639=ends[9];
          }
          if(biggest2639 == 1){
            active[1]=1;
