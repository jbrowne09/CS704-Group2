    ...
    RUN: while(true){
      switch(S3901){
        ...
        case 1 : 
          ...
          int biggest3911 = 0;
          if(ends[2]>=biggest3911){
            biggest3911=ends[2];
          }
          if(ends[3]>=biggest3911){
            biggest3911=ends[3];
          }
          if(ends[4]>=biggest3911){
            biggest3911=ends[4];
          }
          if(ends[5]>=biggest3911){
            biggest3911=ends[5];
          }
          if(ends[6]>=biggest3911){
            biggest3911=ends[6];
          }
          if(ends[7]>=biggest3911){
            biggest3911=ends[7];
          }
        ...
        case 2 : 
          ...
          int biggest3920 = 0;
          if(ends[2]>=biggest3920){
            biggest3920=ends[2];
          }
          if(ends[3]>=biggest3920){
            biggest3920=ends[3];
          }
          if(ends[4]>=biggest3920){
            biggest3920=ends[4];
          }
          if(ends[5]>=biggest3920){
            biggest3920=ends[5];
          }
          if(ends[6]>=biggest3920){
            biggest3920=ends[6];
          }
          if(ends[7]>=biggest3920){
            biggest3920=ends[7];
          }
          if(ends[8]>=biggest3920){
            biggest3920=ends[8];
          }
          if(ends[9]>=biggest3920){
            biggest3920=ends[9];
          }
          if(biggest3920 == 1){
            active[1]=1;
