    ...
    RUN: while(true){
      switch(S2650){
        ...
        case 1 : 
          ...
          int biggest2660 = 0;
          if(ends[2]>=biggest2660){
            biggest2660=ends[2];
          }
          if(ends[3]>=biggest2660){
            biggest2660=ends[3];
          }
          if(ends[4]>=biggest2660){
            biggest2660=ends[4];
          }
        ...
        case 2 : 
          ...
          if(ends[4]>=biggest2669){
            biggest2669=ends[4];
          }
          if(ends[5]>=biggest2669){
            biggest2669=ends[5];
          }
          if(ends[6]>=biggest2669){
            biggest2669=ends[6];
          }
          if(ends[7]>=biggest2669){
            biggest2669=ends[7];
          }
          if(ends[8]>=biggest2669){
            biggest2669=ends[8];
          }
          if(ends[9]>=biggest2669){
            biggest2669=ends[9];
          }
          if(biggest2669 == 1){
            active[1]=1;
