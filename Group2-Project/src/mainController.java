    ...
    RUN: while(true){
      switch(S3070){
        ...
        case 1 : 
          ...
          int biggest3080 = 0;
          if(ends[2]>=biggest3080){
            biggest3080=ends[2];
          }
          if(ends[3]>=biggest3080){
            biggest3080=ends[3];
          }
          if(ends[4]>=biggest3080){
            biggest3080=ends[4];
          }
          if(ends[5]>=biggest3080){
            biggest3080=ends[5];
          }
          if(ends[6]>=biggest3080){
            biggest3080=ends[6];
          }
          if(ends[7]>=biggest3080){
            biggest3080=ends[7];
          }
          if(ends[8]>=biggest3080){
            biggest3080=ends[8];
          }
          if(ends[9]>=biggest3080){
            biggest3080=ends[9];
          }
          if(biggest3080 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3089 = 0;
          if(ends[2]>=biggest3089){
            biggest3089=ends[2];
          }
          if(ends[3]>=biggest3089){
            biggest3089=ends[3];
          }
          if(ends[4]>=biggest3089){
            biggest3089=ends[4];
          }
          if(ends[5]>=biggest3089){
            biggest3089=ends[5];
          }
          if(ends[6]>=biggest3089){
            biggest3089=ends[6];
          }
          if(ends[7]>=biggest3089){
            biggest3089=ends[7];
          }
          if(ends[8]>=biggest3089){
            biggest3089=ends[8];
          }
          if(ends[9]>=biggest3089){
            biggest3089=ends[9];
          }
          if(biggest3089 == 1){
            active[1]=1;
