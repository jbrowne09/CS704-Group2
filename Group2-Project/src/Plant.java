...
public class Plant extends ClockDomain{
  ...
  public void thread2019(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2026 = 0;
        if(ends[8]>=biggest2026){
          biggest2026=ends[8];
        }
        if(ends[9]>=biggest2026){
          biggest2026=ends[9];
        }
        if(ends[10]>=biggest2026){
          biggest2026=ends[10];
        }
        if(ends[11]>=biggest2026){
          biggest2026=ends[11];
        }
        if(ends[12]>=biggest2026){
          biggest2026=ends[12];
        }
        if(ends[13]>=biggest2026){
          biggest2026=ends[13];
        }
        if(biggest2026 == 1){
          active[7]=1;
  ...
  public void thread2015(int [] tdone, int [] ends){
        switch(S778){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread2005(int [] tdone, int [] ends){
    ...
    int biggest2012 = 0;
    if(ends[8]>=biggest2012){
      biggest2012=ends[8];
    }
    if(ends[9]>=biggest2012){
      biggest2012=ends[9];
    }
    if(ends[10]>=biggest2012){
      biggest2012=ends[10];
    }
    if(ends[11]>=biggest2012){
      biggest2012=ends[11];
    }
    if(ends[12]>=biggest2012){
      biggest2012=ends[12];
    }
    if(ends[13]>=biggest2012){
      biggest2012=ends[13];
    }
    if(biggest2012 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1998){
        ...
        case 1 : 
          ...
          int biggest2013 = 0;
          if(ends[2]>=biggest2013){
            biggest2013=ends[2];
          }
          if(ends[3]>=biggest2013){
            biggest2013=ends[3];
          }
          if(ends[4]>=biggest2013){
            biggest2013=ends[4];
          }
          if(ends[5]>=biggest2013){
            biggest2013=ends[5];
          }
          if(ends[6]>=biggest2013){
            biggest2013=ends[6];
          }
          if(ends[7]>=biggest2013){
            biggest2013=ends[7];
          }
          if(biggest2013 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          if(ends[5]>=biggest2027){
            biggest2027=ends[5];
          }
          if(ends[6]>=biggest2027){
            biggest2027=ends[6];
          }
          if(ends[7]>=biggest2027){
            biggest2027=ends[7];
          }
          if(biggest2027 == 1){
            active[1]=1;
