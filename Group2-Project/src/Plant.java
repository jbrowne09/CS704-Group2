...
public class Plant extends ClockDomain{
  ...
  public void thread7677(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest7684 = 0;
        if(ends[8]>=biggest7684){
          biggest7684=ends[8];
        }
        if(ends[9]>=biggest7684){
          biggest7684=ends[9];
        }
        if(ends[10]>=biggest7684){
          biggest7684=ends[10];
        }
        if(ends[11]>=biggest7684){
          biggest7684=ends[11];
        }
        if(ends[12]>=biggest7684){
          biggest7684=ends[12];
        }
        if(ends[13]>=biggest7684){
          biggest7684=ends[13];
        }
        if(biggest7684 == 1){
          active[7]=1;
  ...
  public void thread7663(int [] tdone, int [] ends){
    ...
    int biggest7670 = 0;
    if(ends[8]>=biggest7670){
      biggest7670=ends[8];
    }
    if(ends[9]>=biggest7670){
      biggest7670=ends[9];
    }
    if(ends[10]>=biggest7670){
      biggest7670=ends[10];
    }
    if(ends[11]>=biggest7670){
      biggest7670=ends[11];
    }
    if(ends[12]>=biggest7670){
      biggest7670=ends[12];
    }
    if(ends[13]>=biggest7670){
      biggest7670=ends[13];
    }
    if(biggest7670 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S7656){
        ...
        case 1 : 
          ...
          int biggest7671 = 0;
          if(ends[2]>=biggest7671){
            biggest7671=ends[2];
          }
          if(ends[3]>=biggest7671){
            biggest7671=ends[3];
          }
          if(ends[4]>=biggest7671){
            biggest7671=ends[4];
          }
          if(ends[5]>=biggest7671){
            biggest7671=ends[5];
          }
          if(ends[6]>=biggest7671){
            biggest7671=ends[6];
          }
          if(ends[7]>=biggest7671){
            biggest7671=ends[7];
          }
          if(biggest7671 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest7685 = 0;
          if(ends[2]>=biggest7685){
            biggest7685=ends[2];
          }
          if(ends[3]>=biggest7685){
            biggest7685=ends[3];
          }
          if(ends[4]>=biggest7685){
            biggest7685=ends[4];
          }
          if(ends[5]>=biggest7685){
            biggest7685=ends[5];
          }
          if(ends[6]>=biggest7685){
            biggest7685=ends[6];
          }
          if(ends[7]>=biggest7685){
            biggest7685=ends[7];
          }
          if(biggest7685 == 1){
            active[1]=1;
