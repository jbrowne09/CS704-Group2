...
public class Plant extends ClockDomain{
  ...
  public void thread2352(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2359 = 0;
        if(ends[8]>=biggest2359){
          biggest2359=ends[8];
        }
        if(ends[9]>=biggest2359){
          biggest2359=ends[9];
        }
        if(ends[10]>=biggest2359){
          biggest2359=ends[10];
        }
        if(ends[11]>=biggest2359){
          biggest2359=ends[11];
        }
        if(ends[12]>=biggest2359){
          biggest2359=ends[12];
        }
        if(ends[13]>=biggest2359){
          biggest2359=ends[13];
        }
        if(biggest2359 == 1){
          active[7]=1;
  ...
  public void thread2338(int [] tdone, int [] ends){
        S1335=1;
    ...
    int biggest2345 = 0;
    if(ends[8]>=biggest2345){
      biggest2345=ends[8];
    }
    if(ends[9]>=biggest2345){
      biggest2345=ends[9];
    }
    if(ends[10]>=biggest2345){
      biggest2345=ends[10];
    }
    if(ends[11]>=biggest2345){
      biggest2345=ends[11];
    }
    if(ends[12]>=biggest2345){
      biggest2345=ends[12];
    }
    if(ends[13]>=biggest2345){
      biggest2345=ends[13];
    }
    if(biggest2345 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S2331){
        ...
        case 1 : 
          ...
          thread2338(tdone,ends);
          int biggest2346 = 0;
          if(ends[2]>=biggest2346){
            biggest2346=ends[2];
          }
          if(ends[3]>=biggest2346){
            biggest2346=ends[3];
          }
          if(ends[4]>=biggest2346){
            biggest2346=ends[4];
          }
          if(ends[5]>=biggest2346){
            biggest2346=ends[5];
          }
          if(ends[6]>=biggest2346){
            biggest2346=ends[6];
          }
          if(ends[7]>=biggest2346){
            biggest2346=ends[7];
          }
          if(biggest2346 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest2360 = 0;
          if(ends[2]>=biggest2360){
            biggest2360=ends[2];
          }
          if(ends[3]>=biggest2360){
            biggest2360=ends[3];
          }
          if(ends[4]>=biggest2360){
            biggest2360=ends[4];
          }
          if(ends[5]>=biggest2360){
            biggest2360=ends[5];
          }
          if(ends[6]>=biggest2360){
            biggest2360=ends[6];
          }
          if(ends[7]>=biggest2360){
            biggest2360=ends[7];
          }
          if(biggest2360 == 1){
            active[1]=1;
