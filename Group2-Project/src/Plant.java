...
public class Plant extends ClockDomain{
  ...
  public void thread1918(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1925 = 0;
        if(ends[8]>=biggest1925){
          biggest1925=ends[8];
        }
        if(ends[9]>=biggest1925){
          biggest1925=ends[9];
        }
        if(ends[10]>=biggest1925){
          biggest1925=ends[10];
        }
        if(ends[11]>=biggest1925){
          biggest1925=ends[11];
        }
        if(ends[12]>=biggest1925){
          biggest1925=ends[12];
        }
        if(ends[13]>=biggest1925){
          biggest1925=ends[13];
        }
        if(biggest1925 == 1){
          active[7]=1;
  ...
  public void thread1904(int [] tdone, int [] ends){
    ...
    int biggest1911 = 0;
    if(ends[8]>=biggest1911){
      biggest1911=ends[8];
    }
    if(ends[9]>=biggest1911){
      biggest1911=ends[9];
    }
    if(ends[10]>=biggest1911){
      biggest1911=ends[10];
    }
    if(ends[11]>=biggest1911){
      biggest1911=ends[11];
    }
    if(ends[12]>=biggest1911){
      biggest1911=ends[12];
    }
    if(ends[13]>=biggest1911){
      biggest1911=ends[13];
    }
    if(biggest1911 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1897){
        ...
        case 1 : 
          ...
          int biggest1912 = 0;
          if(ends[2]>=biggest1912){
            biggest1912=ends[2];
          }
          if(ends[3]>=biggest1912){
            biggest1912=ends[3];
          }
          if(ends[4]>=biggest1912){
            biggest1912=ends[4];
          }
          if(ends[5]>=biggest1912){
            biggest1912=ends[5];
          }
          if(ends[6]>=biggest1912){
            biggest1912=ends[6];
          }
          if(ends[7]>=biggest1912){
            biggest1912=ends[7];
          }
          if(biggest1912 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest1926 = 0;
          if(ends[2]>=biggest1926){
            biggest1926=ends[2];
          }
          if(ends[3]>=biggest1926){
            biggest1926=ends[3];
          }
          if(ends[4]>=biggest1926){
            biggest1926=ends[4];
          }
          if(ends[5]>=biggest1926){
            biggest1926=ends[5];
          }
          if(ends[6]>=biggest1926){
            biggest1926=ends[6];
          }
          if(ends[7]>=biggest1926){
            biggest1926=ends[7];
          }
          if(biggest1926 == 1){
            active[1]=1;
