...
public class Plant extends ClockDomain{
  ...
  public void thread4558(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest4565 = 0;
        if(ends[8]>=biggest4565){
          biggest4565=ends[8];
        }
        if(ends[9]>=biggest4565){
          biggest4565=ends[9];
        }
        if(ends[10]>=biggest4565){
          biggest4565=ends[10];
        }
        if(ends[11]>=biggest4565){
          biggest4565=ends[11];
        }
        if(ends[12]>=biggest4565){
          biggest4565=ends[12];
        }
        if(ends[13]>=biggest4565){
          biggest4565=ends[13];
        }
        if(biggest4565 == 1){
          active[7]=1;
  ...
  public void thread4544(int [] tdone, int [] ends){
    ...
    int biggest4551 = 0;
    if(ends[8]>=biggest4551){
      biggest4551=ends[8];
    }
    if(ends[9]>=biggest4551){
      biggest4551=ends[9];
    }
    if(ends[10]>=biggest4551){
      biggest4551=ends[10];
    }
    if(ends[11]>=biggest4551){
      biggest4551=ends[11];
    }
    if(ends[12]>=biggest4551){
      biggest4551=ends[12];
    }
    if(ends[13]>=biggest4551){
      biggest4551=ends[13];
    }
    if(biggest4551 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S4537){
        ...
        case 1 : 
          ...
          int biggest4552 = 0;
          if(ends[2]>=biggest4552){
            biggest4552=ends[2];
          }
          if(ends[3]>=biggest4552){
            biggest4552=ends[3];
          }
          if(ends[4]>=biggest4552){
            biggest4552=ends[4];
          }
          if(ends[5]>=biggest4552){
            biggest4552=ends[5];
          }
          if(ends[6]>=biggest4552){
            biggest4552=ends[6];
          }
          if(ends[7]>=biggest4552){
            biggest4552=ends[7];
          }
          if(biggest4552 == 1){
            active[1]=1;
