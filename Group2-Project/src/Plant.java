...
public class Plant extends ClockDomain{
  ...
  public void thread4493(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest4500 = 0;
        if(ends[8]>=biggest4500){
          biggest4500=ends[8];
        }
        if(ends[9]>=biggest4500){
          biggest4500=ends[9];
        }
        if(ends[10]>=biggest4500){
          biggest4500=ends[10];
        }
        if(ends[11]>=biggest4500){
          biggest4500=ends[11];
        }
        if(ends[12]>=biggest4500){
          biggest4500=ends[12];
        }
        if(ends[13]>=biggest4500){
          biggest4500=ends[13];
        }
        if(biggest4500 == 1){
          active[7]=1;
  ...
  public void thread4479(int [] tdone, int [] ends){
    ...
    int biggest4486 = 0;
    if(ends[8]>=biggest4486){
      biggest4486=ends[8];
    }
    if(ends[9]>=biggest4486){
      biggest4486=ends[9];
    }
    if(ends[10]>=biggest4486){
      biggest4486=ends[10];
    }
    if(ends[11]>=biggest4486){
      biggest4486=ends[11];
    }
    if(ends[12]>=biggest4486){
      biggest4486=ends[12];
    }
    if(ends[13]>=biggest4486){
      biggest4486=ends[13];
    }
    if(biggest4486 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S4472){
        ...
        case 1 : 
          ...
          int biggest4487 = 0;
          if(ends[2]>=biggest4487){
            biggest4487=ends[2];
          }
          if(ends[3]>=biggest4487){
            biggest4487=ends[3];
          }
          if(ends[4]>=biggest4487){
            biggest4487=ends[4];
          }
          if(ends[5]>=biggest4487){
            biggest4487=ends[5];
          }
          if(ends[6]>=biggest4487){
            biggest4487=ends[6];
          }
          if(ends[7]>=biggest4487){
            biggest4487=ends[7];
          }
          if(biggest4487 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          if(ends[5]>=biggest4501){
            biggest4501=ends[5];
          }
          if(ends[6]>=biggest4501){
            biggest4501=ends[6];
          }
          if(ends[7]>=biggest4501){
            biggest4501=ends[7];
          }
          if(biggest4501 == 1){
            active[1]=1;
