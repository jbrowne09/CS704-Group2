...
public class Plant extends ClockDomain{
  ...
  public void thread4333(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest4340 = 0;
        if(ends[8]>=biggest4340){
          biggest4340=ends[8];
        }
        if(ends[9]>=biggest4340){
          biggest4340=ends[9];
        }
        if(ends[10]>=biggest4340){
          biggest4340=ends[10];
        }
        if(ends[11]>=biggest4340){
          biggest4340=ends[11];
        }
        if(ends[12]>=biggest4340){
          biggest4340=ends[12];
        }
        if(ends[13]>=biggest4340){
          biggest4340=ends[13];
        }
        if(biggest4340 == 1){
          active[7]=1;
  ...
  public void thread4328(int [] tdone, int [] ends){
        switch(S3039){
      case 0 : 
        active[2]=0;
        ends[2]=0;
  ...
  public void thread4319(int [] tdone, int [] ends){
    ...
    int biggest4326 = 0;
    if(ends[8]>=biggest4326){
      biggest4326=ends[8];
    }
    if(ends[9]>=biggest4326){
      biggest4326=ends[9];
    }
    if(ends[10]>=biggest4326){
      biggest4326=ends[10];
    }
    if(ends[11]>=biggest4326){
      biggest4326=ends[11];
    }
    if(ends[12]>=biggest4326){
      biggest4326=ends[12];
    }
    if(ends[13]>=biggest4326){
      biggest4326=ends[13];
    }
    if(biggest4326 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S4312){
        ...
        case 1 : 
          ...
          int biggest4327 = 0;
          if(ends[2]>=biggest4327){
            biggest4327=ends[2];
          }
          if(ends[3]>=biggest4327){
            biggest4327=ends[3];
          }
          if(ends[4]>=biggest4327){
            biggest4327=ends[4];
          }
          if(ends[5]>=biggest4327){
            biggest4327=ends[5];
          }
          if(ends[6]>=biggest4327){
            biggest4327=ends[6];
          }
          if(ends[7]>=biggest4327){
            biggest4327=ends[7];
          }
          if(biggest4327 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest4341 = 0;
          if(ends[2]>=biggest4341){
            biggest4341=ends[2];
          }
          if(ends[3]>=biggest4341){
            biggest4341=ends[3];
          }
          if(ends[4]>=biggest4341){
            biggest4341=ends[4];
          }
          if(ends[5]>=biggest4341){
            biggest4341=ends[5];
          }
          if(ends[6]>=biggest4341){
            biggest4341=ends[6];
          }
          if(ends[7]>=biggest4341){
            biggest4341=ends[7];
          }
          if(biggest4341 == 1){
            active[1]=1;
