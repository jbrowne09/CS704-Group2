...
public class Plant extends ClockDomain{
  ...
  public void thread3856(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest3863 = 0;
        if(ends[8]>=biggest3863){
          biggest3863=ends[8];
        }
        if(ends[9]>=biggest3863){
          biggest3863=ends[9];
        }
        if(ends[10]>=biggest3863){
          biggest3863=ends[10];
        }
        if(ends[11]>=biggest3863){
          biggest3863=ends[11];
        }
        if(ends[12]>=biggest3863){
          biggest3863=ends[12];
        }
        if(ends[13]>=biggest3863){
          biggest3863=ends[13];
        }
        if(biggest3863 == 1){
          active[7]=1;
  ...
  public void thread3842(int [] tdone, int [] ends){
    ...
    int biggest3849 = 0;
    if(ends[8]>=biggest3849){
      biggest3849=ends[8];
    }
    if(ends[9]>=biggest3849){
      biggest3849=ends[9];
    }
    if(ends[10]>=biggest3849){
      biggest3849=ends[10];
    }
    if(ends[11]>=biggest3849){
      biggest3849=ends[11];
    }
    if(ends[12]>=biggest3849){
      biggest3849=ends[12];
    }
    if(ends[13]>=biggest3849){
      biggest3849=ends[13];
    }
    if(biggest3849 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S3835){
        ...
        case 1 : 
          ...
          if(ends[5]>=biggest3850){
            biggest3850=ends[5];
          }
          if(ends[6]>=biggest3850){
            biggest3850=ends[6];
          }
          if(ends[7]>=biggest3850){
            biggest3850=ends[7];
          }
          if(biggest3850 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3864 = 0;
          if(ends[2]>=biggest3864){
            biggest3864=ends[2];
          }
          if(ends[3]>=biggest3864){
            biggest3864=ends[3];
          }
          if(ends[4]>=biggest3864){
            biggest3864=ends[4];
          }
          if(ends[5]>=biggest3864){
            biggest3864=ends[5];
          }
          if(ends[6]>=biggest3864){
            biggest3864=ends[6];
          }
          if(ends[7]>=biggest3864){
            biggest3864=ends[7];
          }
          if(biggest3864 == 1){
            active[1]=1;
