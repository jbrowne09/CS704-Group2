...
public class Plant extends ClockDomain{
  ...
  public void thread3628(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest3635 = 0;
        if(ends[8]>=biggest3635){
          biggest3635=ends[8];
        }
        if(ends[9]>=biggest3635){
          biggest3635=ends[9];
        }
        if(ends[10]>=biggest3635){
          biggest3635=ends[10];
        }
        if(ends[11]>=biggest3635){
          biggest3635=ends[11];
        }
        if(ends[12]>=biggest3635){
          biggest3635=ends[12];
        }
        if(ends[13]>=biggest3635){
          biggest3635=ends[13];
        }
        if(biggest3635 == 1){
          active[7]=1;
  ...
  public void thread3614(int [] tdone, int [] ends){
    ...
    if(ends[12]>=biggest3621){
      biggest3621=ends[12];
    }
    if(ends[13]>=biggest3621){
      biggest3621=ends[13];
    }
    if(biggest3621 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S3607){
        ...
        case 1 : 
          ...
          if(ends[6]>=biggest3622){
            biggest3622=ends[6];
          }
          if(ends[7]>=biggest3622){
            biggest3622=ends[7];
          }
          if(biggest3622 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3636 = 0;
          if(ends[2]>=biggest3636){
            biggest3636=ends[2];
          }
          if(ends[3]>=biggest3636){
            biggest3636=ends[3];
          }
          if(ends[4]>=biggest3636){
            biggest3636=ends[4];
          }
          if(ends[5]>=biggest3636){
            biggest3636=ends[5];
          }
          if(ends[6]>=biggest3636){
            biggest3636=ends[6];
          }
          if(ends[7]>=biggest3636){
            biggest3636=ends[7];
          }
          if(biggest3636 == 1){
            active[1]=1;
