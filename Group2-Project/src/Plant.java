...
public class Plant extends ClockDomain{
  ...
  public void thread7177(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest7184 = 0;
        if(ends[8]>=biggest7184){
          biggest7184=ends[8];
        }
        if(ends[9]>=biggest7184){
          biggest7184=ends[9];
        }
        if(ends[10]>=biggest7184){
          biggest7184=ends[10];
        }
        if(ends[11]>=biggest7184){
          biggest7184=ends[11];
        }
        if(ends[12]>=biggest7184){
          biggest7184=ends[12];
        }
        if(ends[13]>=biggest7184){
          biggest7184=ends[13];
        }
        if(biggest7184 == 1){
          active[7]=1;
  ...
  public void thread7163(int [] tdone, int [] ends){
    ...
    int biggest7170 = 0;
    if(ends[8]>=biggest7170){
      biggest7170=ends[8];
    }
    if(ends[9]>=biggest7170){
      biggest7170=ends[9];
    }
    if(ends[10]>=biggest7170){
      biggest7170=ends[10];
    }
    if(ends[11]>=biggest7170){
      biggest7170=ends[11];
    }
    if(ends[12]>=biggest7170){
      biggest7170=ends[12];
    }
    if(ends[13]>=biggest7170){
      biggest7170=ends[13];
    }
    if(biggest7170 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S7156){
        ...
        case 1 : 
          ...
          int biggest7171 = 0;
          if(ends[2]>=biggest7171){
            biggest7171=ends[2];
          }
          if(ends[3]>=biggest7171){
            biggest7171=ends[3];
          }
          if(ends[4]>=biggest7171){
            biggest7171=ends[4];
          }
          if(ends[5]>=biggest7171){
            biggest7171=ends[5];
          }
          if(ends[6]>=biggest7171){
            biggest7171=ends[6];
          }
          if(ends[7]>=biggest7171){
            biggest7171=ends[7];
          }
          if(biggest7171 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest7185 = 0;
          if(ends[2]>=biggest7185){
            biggest7185=ends[2];
          }
          if(ends[3]>=biggest7185){
            biggest7185=ends[3];
          }
          if(ends[4]>=biggest7185){
            biggest7185=ends[4];
          }
          if(ends[5]>=biggest7185){
            biggest7185=ends[5];
          }
          if(ends[6]>=biggest7185){
            biggest7185=ends[6];
          }
          if(ends[7]>=biggest7185){
            biggest7185=ends[7];
          }
          if(biggest7185 == 1){
            active[1]=1;
