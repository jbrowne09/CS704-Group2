...
public class Plant extends ClockDomain{
  ...
  public void thread2007(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2014 = 0;
        if(ends[8]>=biggest2014){
          biggest2014=ends[8];
        }
        if(ends[9]>=biggest2014){
          biggest2014=ends[9];
        }
        if(ends[10]>=biggest2014){
          biggest2014=ends[10];
        }
        if(ends[11]>=biggest2014){
          biggest2014=ends[11];
        }
        if(ends[12]>=biggest2014){
          biggest2014=ends[12];
        }
        if(ends[13]>=biggest2014){
          biggest2014=ends[13];
        }
        if(biggest2014 == 1){
          active[7]=1;
  ...
  public void thread1993(int [] tdone, int [] ends){
    ...
    int biggest2000 = 0;
    if(ends[8]>=biggest2000){
      biggest2000=ends[8];
    }
    if(ends[9]>=biggest2000){
      biggest2000=ends[9];
    }
    if(ends[10]>=biggest2000){
      biggest2000=ends[10];
    }
    if(ends[11]>=biggest2000){
      biggest2000=ends[11];
    }
    if(ends[12]>=biggest2000){
      biggest2000=ends[12];
    }
    if(ends[13]>=biggest2000){
      biggest2000=ends[13];
    }
    if(biggest2000 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1986){
        ...
        case 1 : 
          ...
          int biggest2001 = 0;
          if(ends[2]>=biggest2001){
            biggest2001=ends[2];
          }
          if(ends[3]>=biggest2001){
            biggest2001=ends[3];
          }
          if(ends[4]>=biggest2001){
            biggest2001=ends[4];
          }
          if(ends[5]>=biggest2001){
            biggest2001=ends[5];
          }
          if(ends[6]>=biggest2001){
            biggest2001=ends[6];
          }
          if(ends[7]>=biggest2001){
            biggest2001=ends[7];
          }
          if(biggest2001 == 1){
            active[1]=1;
