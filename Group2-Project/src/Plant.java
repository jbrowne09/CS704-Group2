...
public class Plant extends ClockDomain{
  ...
  public void thread4552(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest4559 = 0;
        if(ends[8]>=biggest4559){
          biggest4559=ends[8];
        }
        if(ends[9]>=biggest4559){
          biggest4559=ends[9];
        }
        if(ends[10]>=biggest4559){
          biggest4559=ends[10];
        }
        if(ends[11]>=biggest4559){
          biggest4559=ends[11];
        }
        if(ends[12]>=biggest4559){
          biggest4559=ends[12];
        }
        if(ends[13]>=biggest4559){
          biggest4559=ends[13];
        }
        if(biggest4559 == 1){
          active[7]=1;
  ...
  public void thread4538(int [] tdone, int [] ends){
    ...
    int biggest4545 = 0;
    if(ends[8]>=biggest4545){
      biggest4545=ends[8];
    }
    if(ends[9]>=biggest4545){
      biggest4545=ends[9];
    }
    if(ends[10]>=biggest4545){
      biggest4545=ends[10];
    }
    if(ends[11]>=biggest4545){
      biggest4545=ends[11];
    }
    if(ends[12]>=biggest4545){
      biggest4545=ends[12];
    }
    if(ends[13]>=biggest4545){
      biggest4545=ends[13];
    }
    if(biggest4545 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S4531){
        ...
        case 1 : 
          ...
          int biggest4546 = 0;
          if(ends[2]>=biggest4546){
            biggest4546=ends[2];
          }
          if(ends[3]>=biggest4546){
            biggest4546=ends[3];
          }
          if(ends[4]>=biggest4546){
            biggest4546=ends[4];
          }
          if(ends[5]>=biggest4546){
            biggest4546=ends[5];
          }
          if(ends[6]>=biggest4546){
            biggest4546=ends[6];
          }
          if(ends[7]>=biggest4546){
            biggest4546=ends[7];
          }
          if(biggest4546 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest4560 = 0;
          if(ends[2]>=biggest4560){
            biggest4560=ends[2];
          }
          if(ends[3]>=biggest4560){
            biggest4560=ends[3];
          }
          if(ends[4]>=biggest4560){
            biggest4560=ends[4];
          }
          if(ends[5]>=biggest4560){
            biggest4560=ends[5];
          }
          if(ends[6]>=biggest4560){
            biggest4560=ends[6];
          }
          if(ends[7]>=biggest4560){
            biggest4560=ends[7];
          }
          if(biggest4560 == 1){
            active[1]=1;
