...
public class Plant extends ClockDomain{
  ...
  public void thread7639(int [] tdone, int [] ends){
    ...
    int biggest7646 = 0;
    if(ends[8]>=biggest7646){
      biggest7646=ends[8];
    }
    if(ends[9]>=biggest7646){
      biggest7646=ends[9];
    }
    if(ends[10]>=biggest7646){
      biggest7646=ends[10];
    }
    if(ends[11]>=biggest7646){
      biggest7646=ends[11];
    }
    if(ends[12]>=biggest7646){
      biggest7646=ends[12];
    }
    if(ends[13]>=biggest7646){
      biggest7646=ends[13];
    }
    if(biggest7646 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S7632){
        ...
        case 1 : 
          ...
          int biggest7647 = 0;
          if(ends[2]>=biggest7647){
            biggest7647=ends[2];
          }
          if(ends[3]>=biggest7647){
            biggest7647=ends[3];
          }
          if(ends[4]>=biggest7647){
            biggest7647=ends[4];
          }
          if(ends[5]>=biggest7647){
            biggest7647=ends[5];
          }
          if(ends[6]>=biggest7647){
            biggest7647=ends[6];
          }
          if(ends[7]>=biggest7647){
            biggest7647=ends[7];
          }
          if(biggest7647 == 1){
            active[1]=1;
