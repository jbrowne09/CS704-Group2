...
public class Plant extends ClockDomain{
  ...
  public void thread4850(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest4857 = 0;
        if(ends[8]>=biggest4857){
          biggest4857=ends[8];
        }
        if(ends[9]>=biggest4857){
          biggest4857=ends[9];
        }
        if(ends[10]>=biggest4857){
          biggest4857=ends[10];
        }
        if(ends[11]>=biggest4857){
          biggest4857=ends[11];
        }
        if(ends[12]>=biggest4857){
          biggest4857=ends[12];
        }
        if(ends[13]>=biggest4857){
          biggest4857=ends[13];
        }
        if(biggest4857 == 1){
          active[7]=1;
  ...
  public void thread4836(int [] tdone, int [] ends){
    ...
    int biggest4843 = 0;
    if(ends[8]>=biggest4843){
      biggest4843=ends[8];
    }
    if(ends[9]>=biggest4843){
      biggest4843=ends[9];
    }
    if(ends[10]>=biggest4843){
      biggest4843=ends[10];
    }
    if(ends[11]>=biggest4843){
      biggest4843=ends[11];
    }
    if(ends[12]>=biggest4843){
      biggest4843=ends[12];
    }
    if(ends[13]>=biggest4843){
      biggest4843=ends[13];
    }
    if(biggest4843 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S4829){
        ...
        case 1 : 
          ...
          int biggest4844 = 0;
          if(ends[2]>=biggest4844){
            biggest4844=ends[2];
          }
          if(ends[3]>=biggest4844){
            biggest4844=ends[3];
          }
          if(ends[4]>=biggest4844){
            biggest4844=ends[4];
          }
          if(ends[5]>=biggest4844){
            biggest4844=ends[5];
          }
          if(ends[6]>=biggest4844){
            biggest4844=ends[6];
          }
          if(ends[7]>=biggest4844){
            biggest4844=ends[7];
          }
          if(biggest4844 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest4858 = 0;
          if(ends[2]>=biggest4858){
            biggest4858=ends[2];
          }
          if(ends[3]>=biggest4858){
            biggest4858=ends[3];
          }
          if(ends[4]>=biggest4858){
            biggest4858=ends[4];
          }
          if(ends[5]>=biggest4858){
            biggest4858=ends[5];
          }
          if(ends[6]>=biggest4858){
            biggest4858=ends[6];
          }
          if(ends[7]>=biggest4858){
            biggest4858=ends[7];
          }
          if(biggest4858 == 1){
            active[1]=1;
