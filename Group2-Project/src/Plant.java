...
public class Plant extends ClockDomain{
  ...
  public void thread2129(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2136 = 0;
        if(ends[8]>=biggest2136){
          biggest2136=ends[8];
        }
        if(ends[9]>=biggest2136){
          biggest2136=ends[9];
        }
        if(ends[10]>=biggest2136){
          biggest2136=ends[10];
        }
        if(ends[11]>=biggest2136){
          biggest2136=ends[11];
        }
        if(ends[12]>=biggest2136){
          biggest2136=ends[12];
        }
        if(ends[13]>=biggest2136){
          biggest2136=ends[13];
        }
        if(biggest2136 == 1){
          active[7]=1;
  ...
  public void thread2115(int [] tdone, int [] ends){
    ...
    if(ends[12]>=biggest2122){
      biggest2122=ends[12];
    }
    if(ends[13]>=biggest2122){
      biggest2122=ends[13];
    }
    if(biggest2122 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S2108){
        ...
        case 1 : 
          ...
          if(ends[3]>=biggest2123){
            biggest2123=ends[3];
          }
          if(ends[4]>=biggest2123){
            biggest2123=ends[4];
          }
          if(ends[5]>=biggest2123){
            biggest2123=ends[5];
          }
          if(ends[6]>=biggest2123){
            biggest2123=ends[6];
          }
          if(ends[7]>=biggest2123){
            biggest2123=ends[7];
          }
          if(biggest2123 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest2137 = 0;
          if(ends[2]>=biggest2137){
            biggest2137=ends[2];
          }
          if(ends[3]>=biggest2137){
            biggest2137=ends[3];
          }
          if(ends[4]>=biggest2137){
            biggest2137=ends[4];
          }
          if(ends[5]>=biggest2137){
            biggest2137=ends[5];
          }
          if(ends[6]>=biggest2137){
            biggest2137=ends[6];
          }
          if(ends[7]>=biggest2137){
            biggest2137=ends[7];
          }
          if(biggest2137 == 1){
            active[1]=1;
