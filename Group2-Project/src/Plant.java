...
public class Plant extends ClockDomain{
  ...
  public void thread1865(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1872 = 0;
        if(ends[8]>=biggest1872){
          biggest1872=ends[8];
        }
        if(ends[9]>=biggest1872){
          biggest1872=ends[9];
        }
        if(ends[10]>=biggest1872){
          biggest1872=ends[10];
        }
        if(ends[11]>=biggest1872){
          biggest1872=ends[11];
        }
        if(ends[12]>=biggest1872){
          biggest1872=ends[12];
        }
        if(ends[13]>=biggest1872){
          biggest1872=ends[13];
        }
        if(biggest1872 == 1){
          active[7]=1;
  ...
  public void thread1851(int [] tdone, int [] ends){
    ...
    if(ends[11]>=biggest1858){
      biggest1858=ends[11];
    }
    if(ends[12]>=biggest1858){
      biggest1858=ends[12];
    }
    if(ends[13]>=biggest1858){
      biggest1858=ends[13];
    }
    if(biggest1858 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1844){
        ...
        case 1 : 
          ...
          int biggest1859 = 0;
          if(ends[2]>=biggest1859){
            biggest1859=ends[2];
          }
          if(ends[3]>=biggest1859){
            biggest1859=ends[3];
          }
          if(ends[4]>=biggest1859){
            biggest1859=ends[4];
          }
          if(ends[5]>=biggest1859){
            biggest1859=ends[5];
          }
          if(ends[6]>=biggest1859){
            biggest1859=ends[6];
          }
          if(ends[7]>=biggest1859){
            biggest1859=ends[7];
          }
          if(biggest1859 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest1873 = 0;
          if(ends[2]>=biggest1873){
            biggest1873=ends[2];
          }
          if(ends[3]>=biggest1873){
            biggest1873=ends[3];
          }
          if(ends[4]>=biggest1873){
            biggest1873=ends[4];
          }
          if(ends[5]>=biggest1873){
            biggest1873=ends[5];
          }
          if(ends[6]>=biggest1873){
            biggest1873=ends[6];
          }
          if(ends[7]>=biggest1873){
            biggest1873=ends[7];
          }
          if(biggest1873 == 1){
            active[1]=1;
