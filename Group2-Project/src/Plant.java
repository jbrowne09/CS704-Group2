...
public class Plant extends ClockDomain{
  ...
  public void thread5848(int [] tdone, int [] ends){
    ...
    int biggest5855 = 0;
    if(ends[8]>=biggest5855){
      biggest5855=ends[8];
    }
    if(ends[9]>=biggest5855){
      biggest5855=ends[9];
    }
    ...
    RUN: while(true){
      switch(S5841){
        ...
        case 1 : 
          ...
          int biggest5856 = 0;
          if(ends[2]>=biggest5856){
            biggest5856=ends[2];
          }
          if(ends[3]>=biggest5856){
            biggest5856=ends[3];
          }
          if(ends[4]>=biggest5856){
            biggest5856=ends[4];
          }
          if(ends[5]>=biggest5856){
            biggest5856=ends[5];
          }
          if(ends[6]>=biggest5856){
            biggest5856=ends[6];
          }
          if(ends[7]>=biggest5856){
            biggest5856=ends[7];
          }
          if(biggest5856 == 1){
            active[1]=1;
