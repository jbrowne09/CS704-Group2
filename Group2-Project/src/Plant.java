...
public class Plant extends ClockDomain{
  ...
  public void thread4669(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest4676 = 0;
        if(ends[8]>=biggest4676){
          biggest4676=ends[8];
        }
        if(ends[9]>=biggest4676){
          biggest4676=ends[9];
        }
        if(ends[10]>=biggest4676){
          biggest4676=ends[10];
        }
        if(ends[11]>=biggest4676){
          biggest4676=ends[11];
        }
        if(ends[12]>=biggest4676){
          biggest4676=ends[12];
        }
        if(ends[13]>=biggest4676){
          biggest4676=ends[13];
        }
        if(biggest4676 == 1){
          active[7]=1;
  ...
  public void thread4655(int [] tdone, int [] ends){
    ...
    int biggest4662 = 0;
    if(ends[8]>=biggest4662){
      biggest4662=ends[8];
    }
    if(ends[9]>=biggest4662){
      biggest4662=ends[9];
    }
    if(ends[10]>=biggest4662){
      biggest4662=ends[10];
    }
    if(ends[11]>=biggest4662){
      biggest4662=ends[11];
    }
    if(ends[12]>=biggest4662){
      biggest4662=ends[12];
    }
    if(ends[13]>=biggest4662){
      biggest4662=ends[13];
    }
    if(biggest4662 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S4648){
        ...
        case 1 : 
          ...
          int biggest4663 = 0;
          if(ends[2]>=biggest4663){
            biggest4663=ends[2];
          }
          if(ends[3]>=biggest4663){
            biggest4663=ends[3];
          }
          if(ends[4]>=biggest4663){
            biggest4663=ends[4];
          }
          if(ends[5]>=biggest4663){
            biggest4663=ends[5];
          }
          if(ends[6]>=biggest4663){
            biggest4663=ends[6];
          }
          if(ends[7]>=biggest4663){
            biggest4663=ends[7];
          }
          if(biggest4663 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest4677 = 0;
          if(ends[2]>=biggest4677){
            biggest4677=ends[2];
          }
          if(ends[3]>=biggest4677){
            biggest4677=ends[3];
          }
          if(ends[4]>=biggest4677){
            biggest4677=ends[4];
          }
          if(ends[5]>=biggest4677){
            biggest4677=ends[5];
          }
          if(ends[6]>=biggest4677){
            biggest4677=ends[6];
          }
          if(ends[7]>=biggest4677){
            biggest4677=ends[7];
          }
          if(biggest4677 == 1){
            active[1]=1;
