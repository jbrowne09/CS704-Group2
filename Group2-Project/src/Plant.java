...
public class Plant extends ClockDomain{
  ...
  public void thread4334(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest4341 = 0;
        if(ends[8]>=biggest4341){
          biggest4341=ends[8];
        }
        if(ends[9]>=biggest4341){
          biggest4341=ends[9];
        }
        if(ends[10]>=biggest4341){
          biggest4341=ends[10];
        }
        if(ends[11]>=biggest4341){
          biggest4341=ends[11];
        }
        if(ends[12]>=biggest4341){
          biggest4341=ends[12];
        }
        if(ends[13]>=biggest4341){
          biggest4341=ends[13];
        }
        if(biggest4341 == 1){
          active[7]=1;
  ...
  public void thread4320(int [] tdone, int [] ends){
    ...
    int biggest4327 = 0;
    if(ends[8]>=biggest4327){
      biggest4327=ends[8];
    }
    if(ends[9]>=biggest4327){
      biggest4327=ends[9];
    }
    if(ends[10]>=biggest4327){
      biggest4327=ends[10];
    }
    if(ends[11]>=biggest4327){
      biggest4327=ends[11];
    }
    ...
    RUN: while(true){
      switch(S4313){
        ...
        case 2 : 
          ...
          int biggest4342 = 0;
          if(ends[2]>=biggest4342){
            biggest4342=ends[2];
          }
          if(ends[3]>=biggest4342){
            biggest4342=ends[3];
          }
          if(ends[4]>=biggest4342){
            biggest4342=ends[4];
          }
          if(ends[5]>=biggest4342){
            biggest4342=ends[5];
          }
          if(ends[6]>=biggest4342){
            biggest4342=ends[6];
          }
          if(ends[7]>=biggest4342){
            biggest4342=ends[7];
          }
          if(biggest4342 == 1){
            active[1]=1;
