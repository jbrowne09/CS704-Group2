...
public class rotaryPlant extends ClockDomain{
  ...
  public void thread2509(int [] tdone, int [] ends){
        switch(S2495){
      case 0 : 
        active[4]=0;
        ends[4]=0;
      ...
      case 1 : 
        ...
        int biggest2513 = 0;
        if(ends[5]>=biggest2513){
          biggest2513=ends[5];
        }
        if(ends[6]>=biggest2513){
          biggest2513=ends[6];
        }
        if(ends[7]>=biggest2513){
          biggest2513=ends[7];
        }
        if(biggest2513 == 1){
          active[4]=1;
  ...
  public void thread2501(int [] tdone, int [] ends){
    ...
    int biggest2505 = 0;
    if(ends[5]>=biggest2505){
      biggest2505=ends[5];
    }
    if(ends[6]>=biggest2505){
      biggest2505=ends[6];
    }
    if(ends[7]>=biggest2505){
      biggest2505=ends[7];
    }
    if(biggest2505 == 1){
      active[4]=1;
    ...
    RUN: while(true){
      switch(S2497){
        ...
        case 1 : 
          ...
          int biggest2506 = 0;
          if(ends[2]>=biggest2506){
            biggest2506=ends[2];
          }
          if(ends[3]>=biggest2506){
            biggest2506=ends[3];
          }
          if(ends[4]>=biggest2506){
            biggest2506=ends[4];
          }
          if(biggest2506 == 1){
            active[1]=1;
