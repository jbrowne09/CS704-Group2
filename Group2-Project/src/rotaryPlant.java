...
public class rotaryPlant extends ClockDomain{
  ...
  public void thread2683(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2688 = 0;
        if(ends[4]>=biggest2688){
          biggest2688=ends[4];
        }
        if(ends[5]>=biggest2688){
          biggest2688=ends[5];
        }
        if(ends[6]>=biggest2688){
          biggest2688=ends[6];
        }
        if(ends[7]>=biggest2688){
          biggest2688=ends[7];
        }
        if(biggest2688 == 1){
          active[3]=1;
  ...
  public void thread2675(int [] tdone, int [] ends){
    ...
    if(ends[5]>=biggest2680){
      biggest2680=ends[5];
    }
    if(ends[6]>=biggest2680){
      biggest2680=ends[6];
    }
    if(ends[7]>=biggest2680){
      biggest2680=ends[7];
    }
    if(biggest2680 == 1){
      active[3]=1;
    ...
    RUN: while(true){
      switch(S2672){
        ...
        case 1 : 
          ...
          int biggest2681 = 0;
          if(ends[2]>=biggest2681){
            biggest2681=ends[2];
          }
          if(ends[3]>=biggest2681){
            biggest2681=ends[3];
          }
          if(biggest2681 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest2689 = 0;
          if(ends[2]>=biggest2689){
            biggest2689=ends[2];
          }
          if(ends[3]>=biggest2689){
            biggest2689=ends[3];
          }
          if(biggest2689 == 1){
            active[1]=1;
