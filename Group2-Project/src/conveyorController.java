    ...
    RUN: while(true){
      switch(S1419){
        ...
        case 1 : 
          ...
          int biggest1428 = 0;
          if(ends[2]>=biggest1428){
            biggest1428=ends[2];
          }
          if(ends[3]>=biggest1428){
            biggest1428=ends[3];
          }
          if(ends[4]>=biggest1428){
            biggest1428=ends[4];
          }
          if(ends[5]>=biggest1428){
            biggest1428=ends[5];
          }
        ...
        case 2 : 
          ...
          int biggest1436 = 0;
          if(ends[2]>=biggest1436){
            biggest1436=ends[2];
          }
          if(ends[3]>=biggest1436){
            biggest1436=ends[3];
          }
          if(ends[4]>=biggest1436){
            biggest1436=ends[4];
          }
          if(ends[5]>=biggest1436){
            biggest1436=ends[5];
          }
